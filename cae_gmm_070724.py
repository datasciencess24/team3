# This CAE-GMM model works with three features (AE variance, AE energy, EC energy) instead of the four in the previous version. This leads to dramatically improved performance.
...
def extract_features_and_train(train_files, segment_duration_ms):
    ...
    model_path = f'/home/dsbwl24_team003/data/temp/cae_gmm_model_{formatted_time}.pkl'
...
training_data_directory = "/home/dsbwl24_team003/data/temp/Test_202402-5"
#?training_data_directory = "/home/dsbwl24_team003/data/temp/Dressing_6"
...
np.save('/home/dsbwl24_team003/data/temp/Test_202402-5/normal_proportions (080724).npy', normal_proportions)

# Load OK test files and flag recordings as anomalous if needed
test_data_directory = "/home/dsbwl24_team003/data/temp/OK_Measurements"
#?test_data_directory = "/home/dsbwl24_team003/data/temp/NOK_Measurements_test"
...
output_file = f'{test_data_directory}/anomaly_results(OK_Measurements 080724).json'
#?output_file = f'{test_data_directory}/anomaly_results(NOK_Measurements_test 080724).json'
...
# Save results to JSON file
output_file = f'{test_data_directory}/anomaly_results(NOK_Measurements 080724).json'
save_to_json(results, output_file)
